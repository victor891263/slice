        ...
        <>
            ...
            <div className="h-screen flex flex-col items-center px-6 text-gray-700 dark:text-gray-300">
                <div className="max-w-screen-lg w-full py-16 my-auto">
                    ...
                    <Link to="/" className="block mt-2 w-fit mx-auto text-indigo-600 dark:text-indigo-400">Get started</Link>
                    <div className="mt-9 mb-12 relative max-w-sm mx-auto">
                        <input onChange={e => setSearchKeyword(e.target.value)} value={searchKeyword} type="text" name="search" placeholder="What's your URL?" className="w-full rounded bg-transparent border border-gray-300 py-2.5 px-3.5 outline-0 focus:border-indigo-600 dark:border-gray-700 dark:focus:border-indigo-400 dark:placeholder:text-gray-600" />
