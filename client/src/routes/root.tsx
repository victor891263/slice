        ...
        <>
            ...
            <div className="h-screen flex flex-col items-center px-6 text-gray-700 dark:text-gray-300">
                <div className="max-w-2xl w-full h-screen py-20 flex flex-col justify-center">
                    ...
                    {shortenedUrl && (
                        <div className="sm:mt-3 mt-2 bg-gray-100 rounded py-4 px-5 flex items-center justify-between dark:bg-gray-800">
                            <div className="break-all">Your link: <span className="font-bold">{shortenedUrl}</span></div>
                            <button onClick={copyLink} className="max-sm:hidden text-indigo-600 dark:text-indigo-400">Copy</button>
                        </div>
                    )}
                    <Link to='/links' className="text-indigo-600 mt-5 w-fit mx-auto dark:text-indigo-400">View all shortened links</Link>
