    ...
    return (
        <div className="h-screen flex flex-col items-center justify-center">
            <div className="max-w-md text-center">
                <h2 className="mb-6 font-extrabold text-9xl text-gray-400 dark:text-gray-600"><span className="sr-only">Error</span>{info.status}</h2>
                <p className="max-w-xs text-2xl font-semibold md:text-3xl dark:text-white">{info.message}</p>
                <Link to="/" className="mt-8 block w-fit mx-auto px-5 py-3 font-semibold rounded bg-indigo-600 text-white dark:text-black dark:bg-indigo-400">Go back home</Link>
                <div className="mt-6 flex items-center justify-center gap-3 text-gray-700 dark:text-gray-300">
                    <ThemeButton />
